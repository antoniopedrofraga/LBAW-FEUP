		<div class="portfolio-item hvr-grow">
			<a href="../pages/auction.php?id={$auction.idleilao}">
				<img class="carousel-image" alt="" width=200 height=200 style='background: url("{if $auction.imagelink == null }https://placehold.it/800x600{else}{$auction.imagelink}{/if}") 50% 50% no-repeat; background-size: cover; display:block;'>
			</a>
			<h3>
