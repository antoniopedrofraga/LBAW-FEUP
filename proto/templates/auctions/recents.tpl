	...
	<div class="main-carousel">
		...
		<div class="portfolio-item hvr-grow">
			<a href="../pages/auction.php?id={$recentAuction.idleilao}">
				<img class="carousel-image" alt="" width=200 height=200 style='background: url("{if $recentAuction.imagelink == null }https://placehold.it/800x600{else}{$recentAuction.imagelink}{/if}") 50% 50% no-repeat; background-size: cover;'>
			</a>
			<h3>
